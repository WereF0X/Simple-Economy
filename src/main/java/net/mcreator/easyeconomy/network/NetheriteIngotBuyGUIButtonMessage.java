...
import net.mcreator.easyeconomy.procedures.BuyNetheriteIngotx64Procedure;
import net.mcreator.easyeconomy.procedures.BuyNetheriteIngotProcedure;
...
public class NetheriteIngotBuyGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EasyEconomyMod.addNetworkMessage(NetheriteIngotBuyGUIButtonMessage.class, NetheriteIngotBuyGUIButtonMessage::buffer, NetheriteIngotBuyGUIButtonMessage::new, NetheriteIngotBuyGUIButtonMessage::handler);
	}
}
