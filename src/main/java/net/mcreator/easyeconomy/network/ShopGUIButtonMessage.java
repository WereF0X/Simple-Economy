...
import net.mcreator.easyeconomy.procedures.TellMoneyProcedure;
...
public class ShopGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EasyEconomyMod.addNetworkMessage(ShopGUIButtonMessage.class, ShopGUIButtonMessage::buffer, ShopGUIButtonMessage::new, ShopGUIButtonMessage::handler);
	}
}
