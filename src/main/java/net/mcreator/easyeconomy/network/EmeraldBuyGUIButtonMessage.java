...
import net.mcreator.easyeconomy.procedures.BuyEmeraldx64Procedure;
import net.mcreator.easyeconomy.procedures.BuyEmeraldProcedure;
...
public class EmeraldBuyGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EasyEconomyMod.addNetworkMessage(EmeraldBuyGUIButtonMessage.class, EmeraldBuyGUIButtonMessage::buffer, EmeraldBuyGUIButtonMessage::new, EmeraldBuyGUIButtonMessage::handler);
	}
}
