...
public class NetheriteGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SimpleEconomyMod.addNetworkMessage(NetheriteGUIButtonMessage.class, NetheriteGUIButtonMessage::buffer, NetheriteGUIButtonMessage::new, NetheriteGUIButtonMessage::handler);
	}
}
