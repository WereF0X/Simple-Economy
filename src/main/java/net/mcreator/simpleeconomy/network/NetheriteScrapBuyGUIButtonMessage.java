...
import net.mcreator.simpleeconomy.procedures.OpenNetheriteScrapGUIProcedure;
import net.mcreator.simpleeconomy.procedures.BuyNetheriteScrapx64Procedure;
import net.mcreator.simpleeconomy.procedures.BuyNetheriteScrapProcedure;
...
public class NetheriteScrapBuyGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SimpleEconomyMod.addNetworkMessage(NetheriteScrapBuyGUIButtonMessage.class, NetheriteScrapBuyGUIButtonMessage::buffer, NetheriteScrapBuyGUIButtonMessage::new, NetheriteScrapBuyGUIButtonMessage::handler);
	}
}
