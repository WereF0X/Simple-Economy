...
import net.mcreator.simpleeconomy.procedures.OpenCoalBuyGUIProcedure;
...
public class CoalGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SimpleEconomyMod.addNetworkMessage(CoalGUIButtonMessage.class, CoalGUIButtonMessage::buffer, CoalGUIButtonMessage::new, CoalGUIButtonMessage::handler);
	}
}
