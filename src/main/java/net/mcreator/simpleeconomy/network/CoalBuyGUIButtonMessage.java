...
import net.mcreator.simpleeconomy.procedures.BuyCoalx64Procedure;
import net.mcreator.simpleeconomy.procedures.BuyCoalProcedure;
...
public class CoalBuyGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SimpleEconomyMod.addNetworkMessage(CoalBuyGUIButtonMessage.class, CoalBuyGUIButtonMessage::buffer, CoalBuyGUIButtonMessage::new, CoalBuyGUIButtonMessage::handler);
	}
}
