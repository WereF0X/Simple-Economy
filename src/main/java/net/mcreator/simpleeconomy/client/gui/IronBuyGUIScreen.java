...
import net.mcreator.simpleeconomy.network.IronBuyGUIButtonMessage;
...
public class IronBuyGUIScreen extends AbstractContainerScreen<IronBuyGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("simple_economy:textures/screens/iron_buy_gui.png");
	...
	public void init() {
		super.init();
		button_buy_x64 = Button.builder(Component.translatable("gui.simple_economy.iron_buy_gui.button_buy_x64"), e -> {
			if (true) {
				SimpleEconomyMod.PACKET_HANDLER.sendToServer(new IronBuyGUIButtonMessage(0, x, y, z));
		...
		button_buy_x1 = Button.builder(Component.translatable("gui.simple_economy.iron_buy_gui.button_buy_x1"), e -> {
			if (true) {
				SimpleEconomyMod.PACKET_HANDLER.sendToServer(new IronBuyGUIButtonMessage(1, x, y, z));
		...
		button_back = Button.builder(Component.translatable("gui.simple_economy.iron_buy_gui.button_back"), e -> {
			if (true) {
				SimpleEconomyMod.PACKET_HANDLER.sendToServer(new IronBuyGUIButtonMessage(2, x, y, z));
