...
import net.mcreator.simpleeconomy.network.NetheriteIngotBuyGUIButtonMessage;
...
public class NetheriteIngotBuyGUIScreen extends AbstractContainerScreen<NetheriteIngotBuyGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("simple_economy:textures/screens/netherite_ingot_buy_gui.png");
	...
	public void init() {
		super.init();
		button_buy_x64 = Button.builder(Component.translatable("gui.simple_economy.netherite_ingot_buy_gui.button_buy_x64"), e -> {
			if (true) {
				SimpleEconomyMod.PACKET_HANDLER.sendToServer(new NetheriteIngotBuyGUIButtonMessage(0, x, y, z));
		...
		button_buy_x1 = Button.builder(Component.translatable("gui.simple_economy.netherite_ingot_buy_gui.button_buy_x1"), e -> {
			if (true) {
				SimpleEconomyMod.PACKET_HANDLER.sendToServer(new NetheriteIngotBuyGUIButtonMessage(1, x, y, z));
		...
		button_back = Button.builder(Component.translatable("gui.simple_economy.netherite_ingot_buy_gui.button_back"), e -> {
			if (true) {
				SimpleEconomyMod.PACKET_HANDLER.sendToServer(new NetheriteIngotBuyGUIButtonMessage(2, x, y, z));
